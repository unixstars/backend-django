        ...
        user_forms_info = [
            {
                ...
                "재학증명서": (
                    f'=HYPERLINK("{settings.MEDIA_URL}{form.student_user.student_user_profile.univ_certificate.name}", "다운로드")'
                    if form.student_user.student_user_profile.univ_certificate
                    else "없음"
                ),
                "프로필 사진": (
                    f'=HYPERLINK("{settings.MEDIA_URL}{form.student_user.student_user_profile.profile_image.name}", "다운로드")'
